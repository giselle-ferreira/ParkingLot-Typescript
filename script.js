(function () {
    ...
    function patio() {
        ...
        function adicionar(veiculo, salva) {
            ...
            if (salva)
                salvar([...ler(), veiculo]); //vem todos os antigos do método ler() que já estão armazenados e o veículo novo                             
        }
        function remover(placa) {
            ...
            if (!confirm(`O veículo ${nome}, de placa ${placa}, permaneceu por ${tempo}. Deseja encerrar?`))
                return;
